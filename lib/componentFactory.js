...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.row:
      ...
      return format('<table class="%s" '+bgcolor+'><tbody><tr>%s</tr></tbody></table>', classes.join(' '), inner);
    ...
    case this.components.container:
      ...
      return format('<table class="%s" '+bgcolor+'><tbody><tr><td>%s</td></tr></tbody></table>', classes.join(' '), inner);
    ...
    case this.components.spacer:
      ...
      return format('<table class="%s" '+bgcolor+' '+width+'><tbody><tr><td height="'+size+'px" style="font-size:'+size+'px;line-height:'+size+'px;">&#xA0;</td></tr></tbody></table>', classes.join(' '), inner);
